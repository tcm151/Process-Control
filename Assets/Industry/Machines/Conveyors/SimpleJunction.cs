namespace ProcessControl.Industry.Conveyors
{
    ...
    // {
        ...
        //
        // override public IO Input => junction.input;
        ...
        //     junction.input = junction.inputs[0];
        //     return true;
        // }
        //
        ...
        //     junction.input = (junction.inputs.Count >= 1) ? junction.inputs[0] : null;
        //     return true;
        // }
        //
        // protected void NextInput()
        // {
        //     if (!junction.inputEnabled || junction.input is null || junction.maxInputs == 1) return;
        //     junction.input = junction.inputs.ItemAfter(junction.input);
        // }
        //
        // //> CONNECT OUTPUT
